...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <?php // do_action('cc_dashboard_head');?>
        <!-- Stylesheets -->
        <!-- The roboto font is included from Google Web Fonts -->
        <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Roboto:400,400italic,700,700italic">

        <!-- Bootstrap 2.3.2 is included in its original form, unaltered -->
        <link rel="stylesheet" href="/wp-content/plugins/clear-clinic-labs-dashboard/interface/css/bootstrap.css">

        <!-- Related styles of various javascript plugins -->
        <link rel="stylesheet" href="/wp-content/plugins/clear-clinic-labs-dashboard/interface/css/plugins.css">

        <!-- The main stylesheet of this template. All Bootstrap overwrites are defined in here -->
        <link rel="stylesheet" href="/wp-content/plugins/clear-clinic-labs-dashboard/interface/css/main.css">

        <!-- Load a specific file here from css/themes/ folder to alter the default theme of all the template -->
        <?php if ($template['theme']) { ?>
        <link id="theme-link" rel="stylesheet" href="/wp-content/plugins/clear-clinic-labs-dashboard/interface/css/themes/cclabs.css">
        <?php } ?>
        ...
        <script src="/wp-content/plugins/clear-clinic-labs-dashboard/interface/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    </head>
            ...
            <header class="navbar navbar-inverse<?php if ($template['header'] == 'fixed-top') echo ' navbar-fixed-top'; else if ($template['header'] == 'fixed-bottom') echo ' navbar-fixed-bottom'; ?>">
                ...
                <div class="navbar-inner remove-radius remove-box-shadow">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Logo -->
                        <a href="index.php" class="brand">Clear Clinic Labs</a>
                        ...
                        <ul id="widgets" class="nav pull-right">
                            ...
                            <li id="rss-widget" class="dropdown dropdown-left-responsive" style="display:none;">
                            ...
                            <li class="divider-vertical remove-margin"  style="display:none;"></li>

                            <!-- Twitter Widget -->
                            <!-- Add .dropdown-left-responsive class to align the dropdown menu left (so its visible on mobile) -->
                            <li id="twitter-widget" class="dropdown dropdown-left-responsive"  style="display:none;">
                                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"><img src="https://si0.twimg.com/profile_images/1264869537/wordcamp_bigger.jpg" width="24" alt="avatar"> <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                            
                                    <li class="divider"></li>
                                    <li>
                                        <!-- Modal div is at the bottom of the page before including javascript code -->
                                        <a href="#modal-user-settings" role="button" data-toggle="modal">User Profile</a>
                                    </li>
                                <!--     <li>
                                    ...
                                    <li class="divider"></li>
                                    <li>
                                        <a href="page_login.php"> Log out</a>
                                    </li>
                                </ul>
                            </li>
                            <!-- END User Menu -->
