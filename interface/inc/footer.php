...
?>
        <!-- Footer -->
        <footer>
            <span id="year-copy"></span> &copy; Clear Clinic Labs
        </footer>
        <!-- END Footer -->
    </div>
    <!-- END Inner Container -->
...
<script>!window.jQuery && document.write(unescape('%3Cscript src="/wp-content/plugins/clear-clinic-labs-dashboard/interface/js/vendor/jquery-1.9.1.min.js"%3E%3C/script%3E'));</script>

<!-- Bootstrap.js -->
<script src="/wp-content/plugins/clear-clinic-labs-dashboard/interface/js/vendor/bootstrap.min.js"></script>
...
<script src="/wp-content/plugins/clear-clinic-labs-dashboard/interface/js/plugins.js"></script>
<script src="/wp-content/plugins/clear-clinic-labs-dashboard/interface/js/main.js"></script>